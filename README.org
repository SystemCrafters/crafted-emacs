...
and then making some changes to your =early-init.el= and =init.el= Emacs
initialization files, as detailed in the [[file:docs/getting-started-guide.org][Getting Started Guide]].

At the very least, after cloning the Crafted Emacs repo you will need to add the
following to your =early-init.el= configuration:
...
For a more detailed explanation, and examples of futher configuration options, see 
the [[file:docs/getting-started-guide.org][Getting Started Guide]]. There are also
