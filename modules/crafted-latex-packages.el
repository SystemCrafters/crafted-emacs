;;; crafted-latex-packages.el -*- lexical-binding: t; -*-
...
(defun crafted-latex-install-auctex-latexmk ()
...
(provide 'crafted-latex-packages)
;;; crafted-latex-packages.el ends here
